...
import { analyticsCharts, analyticsDashboard, analyticsLive, analyticsLiveDetail, buildReport, naturalLanguageQuery } from './controller';
...
router.get('/live', authorize(['superAdmin'], ['analytics.read']), analyticsLive);
router.get('/live/:category', authorize(['superAdmin'], ['analytics.read']), analyticsLiveDetail);
