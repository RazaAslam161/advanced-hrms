...
export const createRecognition = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const recognition = await PulseService.createRecognition(req.user!.userId, req.body);
