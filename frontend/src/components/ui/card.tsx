...
export const Card = ({ className, interactive = false, onMouseMove, onMouseLeave, style, ...props }: CardProps) => (
  <div
    className={cn(
      'rounded-[1.35rem] border border-[color:var(--color-card-border)] bg-[color:var(--color-card-bg)] p-5 text-[color:var(--color-text)] shadow-panel',
