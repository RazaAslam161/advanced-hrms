    ...
    <div className="space-y-6">
      {canProcessPayroll ? (
        <Card className="space-y-4">
          <h3 className="text-lg font-semibold text-[color:var(--color-heading)]">Process monthly payroll</h3>
        ...
        <Card className="space-y-2">
          <h3 className="text-lg font-semibold text-[color:var(--color-heading)]">My payroll</h3>
          <p className="text-sm theme-muted">Your self-service payslips, tax values, and monthly net salary are localized by employee currency.</p>
          {mutationError && <p className="text-sm text-red-500">{mutationError}</p>}
        </Card>
      )}
      <div className="space-y-6">
