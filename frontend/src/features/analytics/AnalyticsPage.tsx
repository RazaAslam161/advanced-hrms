  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="space-y-4">
        <h3 className="text-lg font-semibold text-[color:var(--color-heading)]">Headcount by department</h3>
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartsQuery.data.departmentDistribution}>
              <CartesianGrid strokeDasharray="3 3" strokeOpacity={0.2} />
              <XAxis dataKey="name" stroke="#a8a2c5" />
              <YAxis allowDecimals={false} stroke="#a8a2c5" />
              <Tooltip />
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <Card className="space-y-4">
          <h3 className="text-lg font-semibold text-[color:var(--color-heading)]">Hiring trend</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <Card className="space-y-4">
          <h3 className="text-lg font-semibold text-[color:var(--color-heading)]">Leave utilization by type</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
